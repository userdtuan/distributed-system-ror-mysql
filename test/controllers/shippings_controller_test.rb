...
class ShippingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping" do
    assert_difference("Shipping.count") do
      post shippings_url, params: { shipping: { date: @shipping.date, destinationid: @shipping.destinationid, kind_of_shipping: @shipping.kind_of_shipping, sourceid: @shipping.sourceid, staffid: @shipping.staffid } }
    end
  ...
  test "should update shipping" do
    patch shipping_url(@shipping), params: { shipping: { date: @shipping.date, destinationid: @shipping.destinationid, kind_of_shipping: @shipping.kind_of_shipping, sourceid: @shipping.sourceid, staffid: @shipping.staffid } }

...
class FarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farm" do
    assert_difference("Farm.count") do
      post farms_url, params: { farm: { address: @farm.address, name: @farm.name, owner_name: @farm.owner_name, productid: @farm.productid } }
    end
  ...
  test "should update farm" do
    patch farm_url(@farm), params: { farm: { address: @farm.address, name: @farm.name, owner_name: @farm.owner_name, productid: @farm.productid } }

class ShippingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shipping.save
        format.html { redirect_to shipping_url(@shipping), notice: "Shipping was successfully created." }
  ...
  private
    ...
    def shipping_params
      params.require(:shipping).permit(:date, :kind_of_shipping, :staffid, :sourceid, :destinationid)
    end
end
